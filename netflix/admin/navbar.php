...
<html lang="en">
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="admin.php"> <img src="../img/logo.png" style="width:100px;"alt=""></a>
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <a href="data_film.php" type="button" class="btn btn-success">Daftar film</a>
                        <a href="data_user.php" type="button" class="btn btn-success mt-2">Daftar user</a>
                        <br>

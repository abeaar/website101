          ...
          <div class="table-responsive">
            <table class="table align-middle" style="text-decoration: none;">
              ...
              <tr>
                ...
                <td>
                  <a href=edit.php?id_film=<?php echo $data['id_film'];?> style="text-decoration:none;">edit</a> |
                  <a href=hapus.php?id_film=<?php echo $data['id_film'];?> style="text-decoration:none" onClick="return confirm('Apakah anda yakin ingin menghapus tersebut??')">delete</a></td>
                  <?php }?>
                </tr>
              </tbody>
            </table>
            ...
            <table class="table align-middle" style="text-decoration: none;">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href=hapus.php?id=<?php echo $data['id'];?> style="text-decoration:none" onClick="return confirm('Apakah anda yakin ingin menghapus tersebut??')">delete</a></td>
                  <?php }?>
                </tr>
              </tbody>
            </table>
